...
hist(
  ...
  main = "Distribuição da criticidade média percebida para o negócio", 
  xlab = "criticidade percebida para o negócio em escala de 0 à 1",
  ylab = "Frequência")
hist(
  businessCriticalityReduced$criticalityMedian,
  main = "Distribuição da criticidade mediana percebida para o negócio", 
  xlab = "criticidade percebida para o negócio em escala de 0 à 1",
  ylab = "Frequência")
hist(
...
{
  chart.Correlation(
    select(businessCriticalityReduced, c(3:4, 13, 16:19, 21:22)),
    histogram = T
  )
